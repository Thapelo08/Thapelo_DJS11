// Import statements assuming FontAwesome dependencies are correctly installed
                        ...
                        <Link to={`/show/${podcast.id}`} className="podcast-link">
                            ...
                            <div className="podcast-details">
                                ...
                                <div className="actions-buttons">
                                    <FontAwesomeIcon
                                        icon={isFavorite(podcast.id) ? solidHeart : regularHeart}
                                        className={`favorite-icon ${isFavorite(podcast.id) ? "favorite" : ""}`}
